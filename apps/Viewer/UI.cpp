		...
		if (strlen(selectionInputBuffer) > 0) {
			...
			case 0: { // Point by Index
				...
				if (pointIndex >= 0 && pointIndex < (int)mvs_scene.pointcloud.points.size())
					...
					ImGui::TextColored(ImVec4(1, 0, 0, 1), "Invalid point index! Range: 0-%zu", mvs_scene.pointcloud.points.size() - 1);
				} break;
			...
			case 1: { // Face by Index
				...
				if (faceIndex >= 0 && faceIndex < (int)mvs_scene.mesh.faces.size())
					...
					ImGui::TextColored(ImVec4(1, 0, 0, 1), "Invalid face index! Range: 0-%zu", mvs_scene.mesh.faces.size() - 1);
				} break;
			...
			case 2: { // Camera by Index
				...
				if (cameraIndex >= 0 && cameraIndex < (int)mvs_scene.images.size())
					...
					ImGui::TextColored(ImVec4(1, 0, 0, 1), "Invalid camera index! Range: 0-%zu", mvs_scene.images.size() - 1);
				} break;
